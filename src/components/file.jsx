...
const VodcastLayout = ({ speed = 40 }) => {
  ...
  return (
    <div className="min-h-screen bg-white ">
      ...
      <main className="px-4 sm:px-8 md:px-16 lg:px-40 pt-8 md:pt-20 lg:pt-36">
        {/* Infinite Scroller */}
        <div className="relative w-full overflow-hidden rounded-md">
          {/* Wrapper for continuous scroll */}
          <div className="flex w-[200%] overflow-hidden">
      {/* First set of images */}
      <div className="flex space-x-4 shrink-0 animate-[scroll_40s_linear_infinite] group">
        <a href="" target="_blank" rel="noopener noreferrer" className="transform transition-all duration-300 hover:scale-110 hover:z-10">
          <img
            src={podcaste5}
            alt="Podcast5"
            className="h-48 sm:h-60 md:h-72 lg:h-80 w-auto rounded-md shadow-lg transition-all duration-300 hover:shadow-xl"
          />
        </a>
        <a
        ...
        {/* Description */}
        <p className="mt-4 md:mt-6 text-xs md:text-sm text-black text-justify ">
