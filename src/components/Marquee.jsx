...
//                 <img
//                   src={picture2}
//                   className="object-cover md:pb-4 grayscale w-full h-full max-w-[6rem] max-h-[6rem] sm:max-w-[4rem] sm:max-h-[4rem] md:max-w-[4rem] md:max-h-[4rem]"
//                   alt="Pauls"
//                 />
//               </div>
//             </div>
...
//                 <img
//                   src={picture4}
//                   className="object-cover md:pt-4 grayscale w-full h-full max-w-[6rem] max-h-[6rem] sm:max-w-[4rem] mt-9 md:mt-0 sm:max-h-[4rem] md:max-w-[4rem] md:max-h-[4rem]"
//                   alt="gnixar"
//                 />
//               </div>
//             </div>
...
//                 <img
//                   src={picture6}
//                    className="object-cover md:pt-6 grayscale w-full h-full max-w-[6rem] max-h-[6rem] sm:max-w-[4rem]  md:mt-0 sm:max-h-[4rem] md:max-w-[6rem] md:max-h-[4rem]"
//                   alt="tedx"
//                   onClick={handleClick}
//                 />
//               </div>
...
export default function Marquee() {
  ...
  return (
    <div className="relative flex flex-col items-center w-full overflow-hidden">
      ...
      <div className="relative flex max-w-full overflow-hidden md:mt-10 mb-20 md:py-5">
        <div className="flex animate-marquee md:max-w-[1200px]">
